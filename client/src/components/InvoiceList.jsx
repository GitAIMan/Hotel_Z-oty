...
import api from '../api';
import { UploadCloud, FileText, CheckCircle, Loader2, AlertCircle, Calendar, CreditCard, Trash2, Edit2, DollarSign, Unlink, Eye } from 'lucide-react';
...
function InvoiceList({ entity }) {
    ...
    const handleViewLinkedDetails = (invoice) => {
        if (!invoice.matchedSettlementFile) return;

        setUnlinkingInvoice({
            ...invoice,
            isInfoOnly: true,
            title: 'Szczegóły powiązania',
            message: `Faktura jest połączona z rozliczeniem:\n📄 ${invoice.matchedSettlementFile}\n\nStatus: Opłacona`
        });
    };
