    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden border border-gold-100">
                ...
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gold-50/30">
                    <div>
                        <h2 className="text-2xl font-serif font-bold text-gray-800">
                            {viewMode ? 'Podgląd powiązania' : 'Połącz z płatnością'}
                        </h2>
                        <p className="text-sm text-gray-500 mt-1">
                            {viewMode ? 'Szczegóły powiązanej transakcji' : 'Wybierz transakcję z rozliczeń, aby opłacić fakturę'}
                        </p>
                    </div>
                ...
                {/* Search - Hide in viewMode or keep? User said "prosty podgląd". Maybe keep but disabled? Or just hide if it's confusing. Let's keep it but maybe readOnly if viewMode? No, user might want to clear it to see others even in view mode? 
                   User said: "Oko ma tylko pokazywac jedną informację... bez możliwości edycji".
                   Let's keep search functional but hide action buttons.
                */}
